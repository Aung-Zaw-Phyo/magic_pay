...
export const loader = ({ request, params }) => {
  ...
  if (!isExistValues) {
    return redirect("/scan-and-pay-form?phone=" + to_phone);
  }
...
export const action = async ({ request, params }) => {
  ...
  const response = await fetch("http://localhost:8000/api/scan-and-pay-complete", {
    method: "POSt",
    headers: {
